...
const MOCK_RECEIPTS: Receipt[] = [
  // Existing payment/security receipts
  {
    id: 'rcp-001',
    suite_id: 'suite-acme',
    office_id: 'office-hq',
  ...
  // NEW: Deploy receipts
  {
    ...
    correlation_id: 'corr-deploy-001',
    payload: { version: '2.4.1', environment: 'production', rollout_pct: 100 },
    provider: 'Internal',
  },
  {
    id: 'rcp-007',
    ...
    correlation_id: 'corr-deploy-002',
    payload: { from_version: '2.4.0', to_version: '2.3.9', reason: 'regression' },
    provider: 'Internal',
  },
  ...
  // NEW: SLO receipts
  {
    ...
    office_id: 'office-eu',
    domain: 'slo',
    action_type: 'slo.breach_detected',
    status: 'success',
    created_at: '2026-02-04T07:30:00Z',
    correlation_id: 'corr-slo-001',
    payload: { slo_name: 'API Latency P95', target_ms: 200, actual_ms: 450, window: '1h' },
    provider: 'Internal',
  },
  {
    id: 'rcp-009',
    ...
    office_id: 'office-eu',
    domain: 'slo',
    action_type: 'slo.recovered',
    status: 'success',
    created_at: '2026-02-04T08:00:00Z',
    correlation_id: 'corr-slo-001',
    payload: { slo_name: 'API Latency P95', current_ms: 145 },
    provider: 'Internal',
  },
  ...
  // NEW: Alert receipts
  {
    ...
    payload: { alert_name: 'High Error Rate', severity: 'P1', channel: 'pagerduty' },
    provider: 'PagerDuty',
  },
  {
    id: 'rcp-011',
    ...
    status: 'success',
    created_at: '2026-02-04T05:05:00Z',
    correlation_id: 'corr-alert-001',
    payload: { acknowledged_by: 'oncall@techstart.io' },
    provider: 'PagerDuty',
  },
  ...
  // NEW: Backup receipts
  {
    ...
    payload: { backup_id: 'bkp-20260204', size_gb: 45.2, duration_min: 12 },
    provider: 'AWS',
  },
  {
    id: 'rcp-013',
    ...
    office_id: 'office-hq',
    domain: 'restore',
    action_type: 'restore.initiated',
    status: 'success',
    created_at: '2026-02-03T18:00:00Z',
    correlation_id: 'corr-restore-001',
    payload: { backup_id: 'bkp-20260203', target_env: 'staging' },
    provider: 'AWS',
  },
  ...
  // NEW: DR receipts
  {
    ...
    office_id: 'office-us',
    domain: 'dr',
    action_type: 'dr.failover_initiated',
    status: 'success',
    created_at: '2026-02-02T14:00:00Z',
    correlation_id: 'corr-dr-001',
    payload: { from_region: 'us-east-1', to_region: 'us-west-2', reason: 'drill' },
    provider: 'AWS',
  },
  {
    id: 'rcp-015',
    ...
    office_id: 'office-us',
    domain: 'dr',
    action_type: 'dr.failover_completed',
    status: 'success',
    created_at: '2026-02-02T14:15:00Z',
    correlation_id: 'corr-dr-001',
    payload: { duration_min: 15, services_migrated: 12 },
    provider: 'AWS',
  },
  
  // NEW: Entitlement receipts
  {
    id: 'rcp-016',
    suite_id: 'suite-techstart',
    office_id: 'office-main',
    domain: 'entitlement',
    action_type: 'entitlement.granted',
    status: 'success',
    created_at: '2026-02-04T11:00:00Z',
    correlation_id: 'corr-ent-001',
    payload: { user: 'jane@techstart.io', entitlement: 'premium_features', expires: '2027-02-04' },
    provider: 'Internal',
  },
  {
    id: 'rcp-017',
    ...
    office_id: 'office-main',
    domain: 'entitlement',
    action_type: 'entitlement.revoked',
    status: 'success',
    created_at: '2026-02-03T10:00:00Z',
    correlation_id: 'corr-ent-002',
    payload: { user: 'old-employee@techstart.io', entitlement: 'admin_access', reason: 'offboarding' },
    provider: 'Internal',
  },
  ...
  // NEW: RBAC receipts
  {
    ...
    office_id: 'office-hq',
    domain: 'rbac',
    action_type: 'rbac.role_assigned',
    status: 'success',
    created_at: '2026-02-04T09:30:00Z',
    correlation_id: 'corr-rbac-001',
    payload: { user: 'new-admin@acme.io', role: 'admin', assigned_by: 'super-admin@acme.io' },
    provider: 'Internal',
  },
  {
    id: 'rcp-019',
    ...
    office_id: 'office-hq',
    domain: 'rbac',
    action_type: 'rbac.permission_changed',
    status: 'success',
    created_at: '2026-02-04T09:35:00Z',
    correlation_id: 'corr-rbac-002',
    payload: { role: 'viewer', permission: 'reports.export', action: 'added' },
    provider: 'Internal',
  },
  
  // NEW: Custom/unknown domain (graceful handling)
  {
    id: 'rcp-020',
    suite_id: 'suite-global',
    office_id: 'office-apac',
    domain: 'custom_integration',
    action_type: 'custom_integration.sync_complete',
    status: 'success',
    created_at: '2026-02-04T04:00:00Z',
    correlation_id: 'corr-custom-001',
    payload: { records_synced: 1250, source: 'legacy_erp' },
    provider: 'Custom',
  },
];
